...
>
 <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/favicon/kapal.ico') }}" />
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/admin" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="{{ asset('assets/img/cruise.png') }}" alt="Seaventures" class="d-inline-block align-text-top"
                    style="height: 40px;">
              </span>
              <span class="demo menu-text fw-bolder ms-2">KMP Merah Putih</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="/admin/notification" class="menu-link">
            ...
            <li class="menu-item">
              <a href="/admin/tiket" class="menu-link">
            ...
            <li class="menu-item">
              <a href="/admin/schedule" class="menu-link">
                ...
                <div data-i18n="Authentications">Jadwal dan Rute</div>
              </a>
